...
public class BigBookofExplanationsTM {
    ...
    SensorColor
        ...
        When connected to a color sensor, it can detect the basic details of a color:
        RGB, Brightness, Distance, etc.
        But we don't have a current use for it.
